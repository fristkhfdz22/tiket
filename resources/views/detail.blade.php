            ...
            <div class="card bordered card-form" style="padding: 30px 40px">
             ...
             <div class="card-bank d-flex align-items-center justify-content-around">
                ...
                <div class="card-bank-content d-flex flex-column">
                  <span>khafidz rizziq alhuda</span>
                </div>
             </div>
              <a onClick="return confirm('Apakah anda sudah membayar ?')" class="btn btn-book btn-block mt-3" href="= Saya mau pesan paket travel {{ $travelPackage->name }} berikut bukti pembayaran saya ! " target="_blank"
                >Booking
                </a
              >
            </div>
